    ...
    {#second target
      ...
      "conditions": [
        ["OS==\"win\" and target_arch==\"x64\"", {
          "copies": [{
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/win64/",
            "files": [
              "<(module_root_dir)/build/Release/lester.node"
            ]
          },
          {
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/win64/checkpoints",
            "files": [
              "<(module_root_dir)/../../checkpoints/ggml-model-f16.bin"
            ]
          },],
        ...
        ["OS==\"win\" and target_arch!=\"x64\"", {
          "copies": [{
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/win32/",
            "files": [
              "<(module_root_dir)/build/Release/lester.node"
            ]
          },
          {
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/win32/checkpoints",
            "files": [
              "<(module_root_dir)/../../checkpoints/ggml-model-f16.bin"
            ]
          },]
        ...
        ["OS==\"linux\" and target_arch==\"x64\"", {
          "copies": [{
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/linux_amd64/",
            "files": [
              "<(module_root_dir)/build/Release/lester.node"
            ]
          },
          {
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/linux_amd64/checkpoints",
            "files": [
              "<(module_root_dir)/../../checkpoints/ggml-model-f16.bin"
            ]
          },]
        ...
        ["OS==\"linux\" and target_arch!=\"x64\"", {
          "copies": [{
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/linux_x86/",
            "files": [
              "<(module_root_dir)/build/Release/lester.node"
            ]
          },
          {
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/linux_x86/checkpoints",
            "files": [
              "<(module_root_dir)/../../checkpoints/ggml-model-f16.bin"
            ]
          },]
        ...
        ["OS==\"mac\"", {
          "copies": [{
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/mac/",
            "files": [
              "<(module_root_dir)/build/Release/lester.node"
            ]
          },
          {
            "destination": "<(module_root_dir)/publish/segment-anything-model/bin/mac/checkpoints",
            "files": [
              "<(module_root_dir)/../../checkpoints/ggml-model-f16.bin"
            ]
          },
