SUMMARY: 
	- Build where the binding.gyp is. The result is a native addon. Can be used diretly
	- To publish you need a conventional module, with a JS file (main.js) that access the native addon. 
