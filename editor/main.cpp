...
int main_loop(sam_image_u8 img, const sam_params & params, sam_state & state) {
    ...
    IMGUI_API ImGuiIO & io = ImGui::GetIO();//testing, not used 
    SDL_Window * window = SDL_CreateWindow(title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1500, 1000, window_flags);
